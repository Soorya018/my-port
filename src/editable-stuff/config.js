...
const skills = {
  ...
  heading: "Skills",
  hardSkills: [
    { name: "JavaScript, Python, HTML, CSS, XML, JSON", value: 90 },
    { name: "Chrome DevTools, Firebug", value: 75 },
    { name: "Prometheus, Grafana, Datadog", value: 85 },
    { name: "Linux (Ubuntu, RHEL), Windows Server", value: 65 },
    { name: "DNS, SMTP, POP3, IMAP4, SAML 2.0, SNMP, TCP/IP", value: 90 },
    { name: "ITIL 4, SRE, CMDB", value: 65 },
    { name: "Zendesk, JIRA, ServiceDesk Plus", value: 55 },
    { name: "REST APIs, Webhooks, Browser-based Troubleshooting, Web Application Stack", value: 80 },
  ],
  softSkills: [
